import { LucidePlay, LucideApple } from 'lucide-react'
      ...
      <div className='text-black h-full flex sm:flex-row justify-center flex-col max-sm:mt-10 max-sm:gap-8 gap-12 w-full max-h-[80%] sm:h-[80%] items-center'>
        ...
        <div className="flex flex-col w-full items-center max-sm:text-center">
          <div className='space-y-4'>
            <h2 className='text-4xl text-[#262364] font-semibold leading-tight'>
            ...
            <div className="flex flex-row sm:gap-4  gap-2  max-sm:w-full max-sm:justify-center max-sm:flex-col ">
              <a
                ...
                className="sm:text-lg flex text-center justify-center gap-2 max-sm:w-full text-base  border-solid border border-slate-400 text-slate-600 rounded-full sm:px-7 sm:py-3 px-6 py-3 font-semibold transition duration-300 ease hover:scale-[1.1] hover:bg-slate-50 "
              >
                <Image
