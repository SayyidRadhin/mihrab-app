...
export default function Home() {
  ...
  return (
    <div className=" scroll-smooth bg-secondaryAccent font-raleway overflow-hidden grid w-full min-h-screen   ">
      <Head>
  <title>Mehrab Academy | Quran App</title>
  <meta name="description" content="Discover the Mehrab Academy Quran App. Learn madrasa education on the go with our mobile app, available on Play Store and App Store." />
  <meta property="og:title" content="Mehrab Academy | Quran App" />
  <meta property="og:description" content="Discover the Mehrab Academy Quran App. Learn madrasa education on the go with our mobile app, available on Play Store and App Store." />
  <meta name="twitter:title" content="Mehrab Academy | Quran App" />
  <meta name="twitter:description" content="Discover the Mehrab Academy Quran App. Learn madrasa education on the go with our mobile app, available on Play Store and App Store." />
</Head>
      <NavbarQuran />
