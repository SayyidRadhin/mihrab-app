...
export default function Home() {
  ...
  return (
    <div className=" scroll-smooth bg-secondary font-raleway overflow-hidden grid w-full min-h-screen   ">
      <Navbar />
      <section
        id="home"
      ...
      >
        <div className="text-black h-full mt-28 mx-auto justify-center max-sm:mt-10 max-sm:gap-2 gap-2 w-full max-h-[80%] sm:h-[80%] items-center ">
          <div className="flex  flex-col  max-sm:mt-[20vw]  w-full items-center  text-center">
            ...
            <h1 className="sm:text-5xl   text-4xl   mt-[7vw]  max-w-[18ch] sm:leading-[1.2em] text-[#262364] font-bold ">
            ...
            <div className="flex flex-row  sm:gap-4 gap-2 max-sm:w-full items-center">
              <button
                onClick={onClick}
                className="sm:text-lg flex text-center justify-center gap-1 max-sm:w-full text-base my-6 max-sm:self-center border-solid bg-[#262364]  text-white rounded-full sm:px-7 sm:py-3 px-6 py-3 font-semibold transition duration-300 ease hover:scale-[1.1] hover:bg-opacity-95"
              >
                Learn more 
              </button>
              <button
                onClick={onClick}
                className="sm:text-lg text-center  flex gap-1 justify-center max-sm:w-full text-base my-6 max-sm:self-center border-solid border border-slate-400  text-slate-400 rounded-full sm:px-7 sm:py-3 px-6 py-3 font-semibold transition duration-300 ease hover:scale-[1.1] hover:bg-opacity-95"
              >
                Get Touch 
              </button>
            </div>
